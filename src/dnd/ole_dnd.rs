...
//! [`crate::dnd::drop_target`] implements:
//!
...
use super::{OleDropError, OleDroppedData, OleDropPosition};
    ...
    fn read_hdrop(data_obj: *mut IDataObject) -> Option<Vec<PathBuf>> {
        ...
        let paths = crate::dnd::drop_target::extract_paths_from_hdrop(hdrop as _);
...
/// [`OleDroppedData`](crate::dnd::ole_dnd::OleDroppedData)'s
...
mod win_src {
    ...
    #[allow(clippy::upper_case_acronyms)] // mirrors the Win32 header name
    pub type HRESULT = i32;
