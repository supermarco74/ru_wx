...
//!   [`crate::date_picker_ctrl::DatePickerCtrl`] wraps) for the
//!   user to pick a date on,
//! * "OK" and "Cancel" buttons.
//!
//! Unlike [`crate::date_picker_ctrl::DatePickerCtrl`] — which is an
...
//! # Example
//! ```no_run
//! use ru_wx::date_picker_dialog::DatePickerDialog;
//! use ru_wx::date_picker_ctrl::Date;
...
use crate::date_picker_ctrl::Date;
