...
[`timer.md`](./timer.md) module is the right way to keep the
...
- [`widget.md`](./widget.md) — `Window` trait, the bound on the `parent` parameter.
- [`message_box.md`](./message_box.md) — `Err` strings follow the same "human-readable description" pattern.
