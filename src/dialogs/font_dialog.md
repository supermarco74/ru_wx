...
[`Colour::to_colorref`](../core/geometry.md)).

## See Also
- [`font.rs`](../core/font.md) — `Font`, `FontDesc`, `Font::new(desc)`.
- [`color_dialog.rs`](color_dialog.md) — colour-only picker that shares the same `set_title` cross-platform workaround.
- [`colour_picker_ctrl.rs`](../controls/colour_picker_ctrl.md) — inline colour picker control.
