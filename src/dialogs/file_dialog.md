...
## See Also
- [`dialog.rs`](../window/dialog.md) — generic dialog for non-file use cases
- [`message_box.rs`](message_box.md) — quick OK/Cancel prompt
- [`drop_target.rs`](../dnd/drop_target.md) — drag-and-drop file paths is the alternative entry point for files
