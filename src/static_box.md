...
[`Panel`](./panel.md) instead.

## See Also
- [`panel.rs`](./panel.md) — true container with custom WndProc; use for interactive grouped content
- [`static_text.rs`](./static_text.md) — sibling static control without border
- [`sizer.rs`](./sizer.md) — required to lay out children relative to a `StaticBox`
