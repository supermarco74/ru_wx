...
- [grid](../containers/grid.md) — primary consumer (small-icon slot via `LVM_SETIMAGELIST` / `LVSIL_SMALL`).
- [tab](../containers/tab.md) — uses images for tab icons (`add_page_with_image`).
