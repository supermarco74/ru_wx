...
- [`frame.md`](../window/frame.md) — typical parent of a `GLCanvas`.
- [`panel.md`](../window/panel.md) — alternate parent.
- [`widget.md`](../core/widget.md) — `Window` trait, `Widget` trait, `as_widget_ref`.
