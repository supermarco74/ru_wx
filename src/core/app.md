...
- The actual `GetMessage` / `DispatchMessage` loop lives in [`frame.rs`](../window/frame.md) (`Frame::show`), not here.
...
- [`frame.rs`](../window/frame.md) — `Frame::show` is where the message loop actually runs.
