...
## See Also
- [`progress_dialog.rs`](../dialogs/progress_dialog.md) — modal alternative with a progress bar.
- [`message_dialog.rs`](../dialogs/message_dialog.md) — modal alternative for short messages.
