...
//! [`Frame::register_accelerator`](crate::window::frame::Frame::register_accelerator)
...
/// and is also the id used by [`Frame::register_command_handler`](crate::window::frame::Frame::register_command_handler)
/// and by [`Menu::append`](crate::window::menu::Menu::append) callbacks.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
