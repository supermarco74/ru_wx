...
[`BoxSizer`](../containers/sizer.md) to manage size and alignment.

## See Also
- [`frame.rs`](../window/frame.md) — `Frame::register_command_handler` used by `on_click`.
- [`geometry.rs`](../core/geometry.md) — `Colour`, `Rect`, `Colour::to_colorref()`.
