...
impl BitmapButton {
    ...
    pub fn new_from_svg<W: Window>(
        ...
        let (hwnd, hbitmap) = unsafe {
            ...
            let hbitmap = crate::dc::icon::load_svg_as_hbitmap(svg_path, width as u32, height as u32);
    ...
    pub fn new_from_svg_bytes<W: Window>(
        ...
        let (hwnd, hbitmap) = unsafe {
            ...
            let hbitmap =
                crate::dc::icon::svg_bytes_to_hbitmap(svg_bytes, width as u32, height as u32);
            if let Some(hbmp) = hbitmap {
                SendMessageW(hwnd, BM_SETIMAGE, IMAGE_BITMAP, hbmp as isize);
            }
            (hwnd, hbitmap)
