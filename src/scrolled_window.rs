...
use windows_sys::Win32::UI::WindowsAndMessaging::{
    ...
    GetWindowLongPtrW, MoveWindow, SCROLLINFO, SetWindowLongPtrW,
    ShowWindow, GWLP_WNDPROC, HMENU, SIF_PAGE, SIF_POS, SIF_RANGE, SW_HIDE, SW_SHOW,
    WM_HSCROLL, WM_VSCROLL, WS_CHILD, WS_VISIBLE,
};
...
impl ScrolledWindow {
    ...
    pub fn new<W: Window>(parent_in: &W) -> Self {
        ...
        let hwnd = unsafe {
            ...
            let hwnd = CreateWindowExW(
                ...
                wide_class.as_ptr(),
                std::ptr::null(),
                WS_CHILD | WS_VISIBLE | WS_HSCROLL_U | WS_VSCROLL_U,
                0,
                0,
                200,
                200,
    ...
    pub fn set_virtual_size(&self, w: i32, h: i32) {
        ...
        unsafe {
            ...
            let hwnd = data.hwnd;
            let view_w = data.rect.width as i32;
            let view_h = data.rect.height as i32;
            let max_h = (data.virtual_size.0 - view_w).max(0);
            let max_v = (data.virtual_size.1 - view_h).max(0);
    ...
    /// this control. Used by [`crate::sizer::BoxSizer`] to
